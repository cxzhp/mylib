...
int main(int argc,char *argv[])
{
    ...
    //imshow("Distance Transform Image", imageThin);

	//Mat imageNormal;
    //normalize(imageThin, imageNormal, 0, 1., NORM_MINMAX);
    //imshow("normalize Image", imageNormal);
    //scanImageEfficiet(imageNormal);
